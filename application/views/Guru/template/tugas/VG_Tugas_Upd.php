                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <?php 
                            foreach ($tugas as $u) {
                        ?>                      
                            <form action="<?php echo base_url();?>C_Tugas/edit_data" method="post">     
                                <input type="hidden" name="id" value="<?php echo $u->id; ?>">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group label-floating"> 
                                            <label class="label">NIS </label><br>
                                            <select class="icons" name="kd_tugas">
                                                <option value="<?php echo $u->kd_tugas; ?>" selected=""> <?php echo $u->kd_tugas; ?> </option>
                                                <option value="" "> ------------------------------------ </option>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group label-floating"> 
                                            ...
                                            <select class="icons" name="nm_tugas">
                                                <option value="<?php echo $u->nm_tugas; ?>" selected=""> <?php echo $u->nm_tugas; ?>  </option>
                                                <option value="" "> ------------------------------------ </option>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="text" class="form-control" name="nilai_tugas" value="<?php echo $u->nilai_tugas; ?>">
                                        </div>
                                    </div>
                                </div>
