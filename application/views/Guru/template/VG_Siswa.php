...
<head>
    ...
    <title>Siswa Data - SMK Nuswantoro.</title>
                        ...
                        <div class="card-content table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    ...
                                    <th><b><center>Tempat Lahir</center></b></th>
                                    <th><b><center>Tanggal Lahir</center></b></th>
                                    <th><b><center>Alamat</center></b></th>
                                    <th><b><center>Angkatan</center></b></th>
                                </thead>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo $n->tempat_lahir;?></td>
                                        <td><?php echo $n->tanggal_lahir;?></td>
                                        <td><?php echo $n->alamat;?></td>
                                        <td><?php echo $n->tahun_angkatan; ?></td>
                                    </tr>
                                </tbody>
                                <?php } ?>
                            </table>
